package logic.lookuptablegenerator;
...
public class LookupTableGenerator {
	...
	*/
	...
	private static int[]   handRanks = new int[32487834];        // array to hold hand rank lookup table
	...
	/**
	 * Generates a lookup table that can be used to quickly evaluate any given hand.
	 * The lookup table will only be generated once, subsequent calls will simply return
	 * the previously generated table.
	 * 
	 * @return A very large int[].
	 */
